        ...
        Positioned(
          ...
          Column(
            children: [
              ...
              CustomText(text:"Dr Aaron Smith", color: AppColors.themeDarkGrey, fontFamily: "Gilroy-Bold", fontSize: 14,
              fontWeight: FontWeight.w400,
              ),
              SizedBox(height: ScallingConfig.scale(10),),
              CustomText(text:"Therapist", color: AppColors.themeDarkGrey, fontFamily: "Gilroy-Regular", fontSize: 10,
              fontWeight: FontWeight.w400,
              ),
              SizedBox(height: ScallingConfig.scale(10),),
              Row(
              ...
              CustomText(text:"4.5 (135 reviews)", color: AppColors.themeDarkGrey, 
              fontFamily: "Gilroy-Regular", fontSize: 10,
              fontWeight: FontWeight.w400,          ),
                ],
              )
            ],
