...
class _MobileAboutUs extends StatelessWidget {
  ...
  Widget _mobileSection(
    ...
    String title,
    String? body, {
    List<(String, String, IconData)>? bullets,
  }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        children: [
          SizedBox(
            ...
            child: Image.asset(
              ...
              fit: BoxFit.cover,
              errorBuilder: (_, _, _) =>
                  Container(height: 320, color: _primary),
            ),
          ),
          Container(
            width: double.infinity,
    ...
    final imageBlock = ClipRRect(
      ...
      child: Image.asset(
        ...
        errorBuilder: (_, _, _) => Container(
          ...
          child: const Center(
            child: Icon(Icons.image_rounded, size: 48, color: _primary),
          ),
        ),
      ),
    );
                          ...
                          ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              errorBuilder: (_, _, _) => Container(
                                ...
                                child: Center(
                                  child: Icon(b.$3, size: 36, color: b.$4),
                                ),
                              ),
                            ),
                          ),
        ...
        children: [
          SizedBox(
            ...
            child: Image.asset(
              ...
              fit: BoxFit.cover,
              errorBuilder: (_, _, _) =>
                  Container(height: 200, color: _primary),
            ),
          ),
          Container(
            width: double.infinity,
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  _secondary.withValues(alpha: 0.75),
                ],
