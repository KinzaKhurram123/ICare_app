  ...
  Widget _aboutCard(BuildContext context) {
    ...
    return Card(elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _settingsTile(icon: Icons.info_outline, iconColor: const Color(0xFF64748B), title: 'About Us', subtitle: 'Learn more about iCare', onTap: () async { try { await launchUrl(Uri.parse('https://rmhealthsolutions.co.uk/about-us'), mode: LaunchMode.externalApplication); } catch (_) {} }),
        if (showDrugInfo) ...[
          const Divider(height: 1),
  ...
  Widget _aboutCard(BuildContext context) {
    ...
    return Card(elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _settingsTile(icon: Icons.info_outline, iconColor: const Color(0xFF64748B), title: 'About Us', subtitle: 'Learn about iCare', onTap: () async { try { await launchUrl(Uri.parse('https://rmhealthsolutions.co.uk/about-us'), mode: LaunchMode.externalApplication); } catch (_) {} }),
        if (showDrugInfo) ...[
          const Divider(height: 1),
          _settingsTile(icon: Icons.verified_outlined, iconColor: const Color(0xFF10B981), title: 'DRAP Guidelines', subtitle: 'Drug Regulatory Authority of Pakistan', onTap: () async { try { await launchUrl(Uri.parse('https://www.dra.gov.pk'), mode: LaunchMode.externalApplication); } catch (_) {} }),
          const Divider(height: 1),
