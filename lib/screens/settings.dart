...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  final List<Map<String, dynamic>> _settingsList=  [{
                "id" : "1",
                "title" : "Notifications",
                "onPress" : (){ Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => NotificationSettings() )); }
              }, {
                 "id" : "2",
                "title" : "Change Passwords",
                "onPress" : (){ Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => ChangePassword() )); }
              }, {
                 "id" : "3",
                "title" : "Privacy Policy",
                "onPress" : (){ Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => PrivacyPolicy() )); }
              },
              {
                 "id" : "4",
                "title" : "About Us",
                "onPress" : (){ Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => AboutUs() )); }
              },
              {
                 "id" : "5",
                "title" : "Terms & Conditions",
                "onPress" : (){ Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => TermsAndConditions() )); }
              },
              ];
    return Scaffold(
  appBar: AppBar(
