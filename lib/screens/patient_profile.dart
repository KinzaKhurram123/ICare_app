            ...
            onSelected: (value) {
              if (value == 'edit') {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PatientAddressesScreen(),
                  ),
                );
          ...
          child: Column(
            children: [
                      ...
                      if (imgProvider != null) {
                        ...
                        return Image(
                          ...
                          errorBuilder: (_, _, _) => Text(
                            ...
                            style: TextStyle(
                              fontSize: Utils.windowWidth(context) * 0.12,
                ...
                child: Row(
                  ...
                  children: [
                    _infoChip(
                      Icons.cake_outlined,
                      "Age",
                      (user?.age?.isNotEmpty == true) ? user!.age! : "—",
                    ),
                    SizedBox(width: ScallingConfig.scale(10)),
                    _infoChip(
                      Icons.height_rounded,
                      "Height",
                      (user?.height?.isNotEmpty == true) ? user!.height! : "—",
                    ),
                    SizedBox(width: ScallingConfig.scale(10)),
                    _infoChip(
                      Icons.monitor_weight_outlined,
                      "Weight",
                      (user?.weight?.isNotEmpty == true) ? user!.weight! : "—",
                    ),
                  ],
                ),
              ),
              ...
              SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: ScallingConfig.scale(10)),
                    CustomText(
                      text: user?.cnic != null && user!.cnic!.isNotEmpty
                          ? "CNIC: ${user.cnic}"
                          : "CNIC: not set",
                    ),
                  ],
              ...
              Builder(
                builder: (context) {
                  final bio = [
                    if (user?.healthGoals?.isNotEmpty == true)
                      user!.healthGoals!,
                    if (user?.existingConditions?.isNotEmpty == true)
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: CustomText(
                        text:
                            "Medical history, documents and scans are in Medical Records.",
                        fontSize: 12,
                        maxLines: 3,
                      ),
                    ),
