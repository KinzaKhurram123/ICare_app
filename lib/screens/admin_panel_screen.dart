...
class _AdminPanelScreenState extends ConsumerState<AdminPanelScreen>
  ...
  Widget _buildPromotionsTab() {
    return _AdminPromotionsPanel(api: _api);
  }
}
...
class _AdminPromotionsPanel extends StatefulWidget {
  final ApiService api;
  const _AdminPromotionsPanel({required this.api});

  @override
  State<_AdminPromotionsPanel> createState() => _AdminPromotionsPanelState();
}

class _AdminPromotionsPanelState extends State<_AdminPromotionsPanel> {
