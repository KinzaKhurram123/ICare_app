...
class ProfileOrAppointmentViewScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           Padding(
             padding: EdgeInsets.symmetric(horizontal: ScallingConfig.scale(20), vertical: ScallingConfig.scale(13)),
             child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                CustomText(text: "Soap Notes", underline: true,
                isBold: true,
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => SoapNotes()));    
                },
                ),
                CustomText(text: "Intake Notes", underline: true,
                isBold: true,
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => IntakeNotes()));
                },
                ),
              ],
             ),
...
class ConsultationTypeCard extends StatelessWidget {
  const ConsultationTypeCard({super.key,
   this.chat= false,
  this.call= true,
  ...
  Widget build(BuildContext context) {
   return Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: AppColors.darkGreyColor.withAlpha(50)
      )
    ),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Container(
          ...
          child: SvgWrapper(assetPath:
          chat ? 
           ImagePaths.message : call ? ImagePaths.calll : ''),
        ),
