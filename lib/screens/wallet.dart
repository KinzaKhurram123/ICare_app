          ...
          child: Column(
            children: [
              ...
              CustomButton(
                ...
                label: "Top Up", width: Utils.windowWidth(context) * 0.85,),
               SizedBox(height: ScallingConfig.scale(20),),
               CustomText(text: "Recieved Amounts", textAlign: TextAlign.start, width: Utils.windowWidth(context) * 0.8, ),
               SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx,i) { 
                    ...
                    title: CustomText(text: "Lorem Ipsum", 
      ...
      child: Column(
        ...
        children: [
          CustomText(
            ...
            text: "Total Balance", color: AppColors.white,),
          CustomText(text: "30,000", 
          fontSize: 39,
...
class PaymentMethods extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: ScallingConfig.scale(10), vertical: ScallingConfig.scale(10)),
      width: Utils.windowWidth(context) * 0.85,
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [AppColors.veryLightGrey, AppColors.veryLightGrey.withAlpha(0)]),
      ),
      child: Column(
                children: [
                  Row(
